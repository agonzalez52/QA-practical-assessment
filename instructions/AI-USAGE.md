...
- Brainstorm the general approach to the assesment (chatbot)
- Brainstorm automation tools mainly to explore alternatives to the POM Playwright approach I was planning (chatbot)
- Brainstorm edge cases for story (chatbot)
- Ask for the different approaches to authenticated sessions (chatbot)
